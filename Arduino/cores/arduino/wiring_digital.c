...
void pinMode(uint32_t ulPin, uint32_t ulMode)
{
  ...
  if (p != NC) {
    ...
    {
      case INPUT: 
        pin_function(p, CW_PIN_DATA(CW_MODE_INPUT, CW_CNF_INPUT_FLOAT, 0, 0));
        break;
      case OUTPUT:
        pin_function(p, CW_PIN_DATA(CW_MODE_OUTPUT_50MHz, CW_CNF_OUTPUT_PP, 0, 0));
        break;
      case INPUT_PULLUP:
        pin_function(p, CW_PIN_DATA(CW_MODE_INPUT, CW_CNF_INPUT_PUPD, 0x1, 0));
        break;
      case INPUT_PULLDOWN:
        pin_function(p, CW_PIN_DATA(CW_MODE_INPUT, CW_CNF_INPUT_PUPD, 0x2, 0));
        break;
      case INPUT_ANALOG:
        pin_function(p, CW_PIN_DATA(CW_MODE_INPUT, CW_CNF_INPUT_ANALOG, 0, 0));
        break;
      case OUTPUT_OD:
        pin_function(p, CW_PIN_DATA(CW_MODE_OUTPUT_50MHz, CW_CNF_OUTPUT_OD, 0,0));
        break;
      default:
        Error_Handler();
        break;
