...
#define digitalPinToPinName(p) ((((uint32_t)(p)&PNUM_MASK) < NUM_DIGITAL_PINS) ? (PinName)(digitalPin[(uint32_t)(p)&PNUM_MASK] | ((p)&ALTX_MASK)) : (((uint32_t)(p)&PNUM_ANALOG_BASE) == PNUM_ANALOG_BASE) && (((uint32_t)(p)&PNUM_MASK) < NUM_ANALOG_INTERNAL_FIRST) ? (PinName)(digitalPin[analogInputPin[(p)&PNUM_ANALOG_INDEX]] | ((p)&ALTX_MASK)) \
                                                                                                                                                                                                                                                                      : NC)
#else
...
#define analogInputToDigitalPin(p) ((((uint32_t)(p)&PNUM_MASK) < NUM_ANALOG_INPUTS) ? analogInputPin[(uint32_t)(p)&PNUM_MASK] | ((uint32_t)(p)&ALTX_MASK) : (((uint32_t)(p)&PNUM_ANALOG_BASE) == PNUM_ANALOG_BASE) && (((uint32_t)(p)&PNUM_MASK) < NUM_ANALOG_INTERNAL_FIRST) ? analogInputPin[(p)&PNUM_ANALOG_INDEX] | ((uint32_t)(p)&ALTX_MASK) \
                                                                                                                                                                                                                                                                              : (uint32_t)NC)
